#ifndef gamingcoinUNITS_H
#define gamingcoinUNITS_H
...
/** gamingcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for dropdown selection boxes.
*/
class gamingcoinUnits: public QAbstractListModel
{
public:
    explicit gamingcoinUnits(QObject *parent);
...
typedef gamingcoinUnits::Unit gamingcoinUnit;

#endif // gamingcoinUNITS_H
