...
<<<<<<< HEAD
            ...
            std::string strUsage = _("gamingcoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  gamingcoind [options]                     " + "\n" +
                  "  gamingcoind [options] <command> [params]  " + _("Send command to -server or gamingcoind") + "\n" +
...
<<<<<<< HEAD
            ...
            strErrors << _("Error loading wallet.dat: Wallet requires newer version of gamingcoin") << "\n";
